...
'''
if os.path.isfile(path + 'qm/' + join_file):
    os.remove(path + 'qm/' + join_file)
'''
...
df.plot(y='SUM', figsize=(9,6), title='AWB - Atmospheric monthly average flow serie', ylabel='Qm, m³/s')
plt.show()
df.plot(y='Akm2', figsize=(9,6), title='AWB - Atmospheric monthly accumulation area serie', ylabel='A, km²')
plt.show()
...
pivot_table_qm.plot(y=year_list, figsize=(9,6), title='AWB - Atmospheric monthly average flow by year', ylabel='Qm, m³/s')
plt.show()
...
pivot_table_aa.plot(y=year_list, figsize=(9,6), title='AWB - Atmospheric monthly accumulation area by year', ylabel='A, km²')
